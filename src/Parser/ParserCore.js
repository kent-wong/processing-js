...
function parseProcessing(code) {
	...
	// wk_debug
	console.log('wk_debug:', codeWoGenerics);
	console.log('wk_debug:', atoms);
	...
	// 1 - attr; 2 - return type; 3 - method name; 4 - params; 5 - throws; 6 - method body
	var methodsRegex = /\b((?:(?:public|private|final|protected|static|abstract|synchronized)\s+)*)((?!(?:else|new|return|throw|function|public|private|protected)\b)[A-Za-z_$][\w$]*\b(?:\s*\.\s*[A-Za-z_$][\w$]*\b)*(?:\s*"C\d+")*)\s*([A-Za-z_$][\w$]*\b)\s*("B\d+")(\s*throws\s+[A-Za-z_$][\w$]*\b(?:\s*\.\s*[A-Za-z_$][\w$]*\b)*(?:\s*,\s*[A-Za-z_$][\w$]*\b(?:\s*\.\s*[A-Za-z_$][\w$]*\b)*)*)?\s*("A\d+"|;)/g;
	
	// 1 - attr; 2 - type; 3 - field name; 4 - equals sign or comma or $
	var fieldTest = /^((?:(?:public|private|final|protected|static)\s+)*)((?!(?:else|new|return|throw)\b)[A-Za-z_$][\w$]*\b(?:\s*\.\s*[A-Za-z_$][\w$]*\b)*(?:\s*"C\d+")*)\s*([A-Za-z_$][\w$]*\b)\s*(?:"C\d+"\s*)*([=,]|$)/;

	// 1 - attr; 2 - method name === class name; 3 - params; 4 - throws; 5 - method body
	...
	/*
	\b((?:(?:public|private|final|protected|static|abstract|synchronized)\s+)*)
	((?!(?:else|new|return|throw|function|public|private|protected)\b)[A-Za-z_$][\w$]*\b(?:\s*\.\s*[A-Za-z_$][\w$]*\b)*(?:\s*"C\d+")*)\s*
	([A-Za-z_$][\w$]*\b)\s*
	("B\d+")
	(\s*throws\s+[A-Za-z_$][\w$]*\b(?:\s*\.\s*[A-Za-z_$][\w$]*\b)*(?:\s*,\s*[A-Za-z_$][\w$]*\b(?:\s*\.\s*[A-Za-z_$][\w$]*\b)*)*)?\s*
	("A\d+"|;)
	*/

	// 1 - access; 2 - return value; 3 - method name; 4 - params; 5 - throws; 6 - method body
	...
	transformStatements = function(statements, transformMethod, transformClass) {
		...
		while((m = nextStatement.exec(statements)) !== null) {
			if(m[1] !== undefined) { // catch, for ...
				...
				// wk_debug
				console.log('wk_debug:', statement);
